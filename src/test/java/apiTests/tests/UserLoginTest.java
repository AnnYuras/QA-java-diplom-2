...
public class UserLoginTest extends MethodsUserCreation {
    ...
    public void loginWithExistingUserTest() {
        ...
        validateUserCreationResponse(response, email, name);
    ...
    public void loginWithInvalidCredentials() {
        ...
        Response createUserResponse = registerNewUser(email, password, name);
        // Проверка успешного создания пользователя
        validateUserCreationResponse(createUserResponse, email, name);
